...
//
//		//////////////////////////////////
//		// Test classe QueenModel
//		//////////////////////////////////
//
		System.out.println("\nTest classe queenModel");
		PieceModel pieceModel1 = new QueenModel(new Coord('a', 7), PieceSquareColor.BLACK);
		PieceModel pieceModel2 = new QueenModel(new Coord('b', 4), PieceSquareColor.WHITE);
		PieceModel pieceModel3 = new QueenModel(new Coord('e', 7), PieceSquareColor.BLACK);
		System.out.println("pieceModel1 = " + pieceModel1);	// [B[7,a]]
		pieceModel1.move(new Coord('b', 6));
		System.out.println("pieceModel1 = " + pieceModel1);	// [B[6,b]]
		System.out.println("isMoveOk ('b',4) --> ('c',5) = " 
							+ pieceModel2.isMoveOk(new Coord('c',11),false)); // false : hors du cadre
		System.out.println("isMoveOk ('e',7) --> ('d',6) = " 
							+ pieceModel3.isMoveOk(new Coord('d',6),false)); // true : depl. de 1 case sans prise
		pieceModel2.move(new Coord('c', 5));
		pieceModel3.move(new Coord('d', 6));
		System.out.println("isMoveOk ('c',5) --> ('e',7) = " 
							+ pieceModel3.isMoveOk(new Coord('c',3),true)); // false : mauvais déplacement
...
//		System.out.println("getCoordsOnItinerary ('b',4) -> ('c',5) = " + 
//				modelImpl.getCoordsOnItinerary(new Coord('b',4), new Coord('c',5)));	//null
//		System.out.println("getCoordsOnItinerary ('b',4) -> ('d',6) = " + 
//				modelImpl.getCoordsOnItinerary(new Coord('b',4), new Coord('d',6)));	// (c,5)
//
//		//////////////////////////////////
//		// Test classe Model
//		//////////////////////////////////
